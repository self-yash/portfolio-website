...
var SnapElement = class {
  constructor(element, { align = ["start"], ignoreSticky = true, ignoreTransform = false } = {}) {
    ...
    __publicField(this, "debouncedWrapperResize");
    ...
    __publicField(this, "onResize", ([entry]) => {
      if (!(entry == null ? void 0 : entry.borderBoxSize[0])) return;
...
var Snap = class {
  constructor(lenis, { type = "proximity", lerp, easing, duration, distanceThreshold = "50%", debounce: debounceDelay = 500, onSnapStart, onSnapComplete } = {}) {
    ...
    __publicField(this, "snaps", /* @__PURE__ */ new Map());
    __publicField(this, "viewport", {
      width: window.innerWidth,
      height: window.innerHeight
    });
    __publicField(this, "isStopped", false);
    __publicField(this, "onSnapDebounced");
    __publicField(this, "currentSnapIndex");
    __publicField(this, "onWindowResize", () => {
      this.viewport.width = window.innerWidth;
      this.viewport.height = window.innerHeight;
    });
    __publicField(this, "computeSnaps", () => {
    ...
    __publicField(this, "onSnap", (e) => {
      var _a;
      if (this.isStopped) return;
      if (e.event.type === "touchmove") return;
      if (this.options.type === "lock" && ((_a = this.lenis.userData) == null ? void 0 : _a.initiator) === "snap") return;
  ...
  */
  ...
  goTo(index2) {
    ...
    this.lenis.scrollTo(currentSnap.value, {
      ...
      onStart: () => {
        var _a, _b;
        (_b = (_a = this.options).onSnapStart) == null ? void 0 : _b.call(_a, {
      ...
      onComplete: () => {
        var _a, _b;
        (_b = (_a = this.options).onSnapComplete) == null ? void 0 : _b.call(_a, {
          index: this.currentSnapIndex,
          ...currentSnap
        });
      }
...
//# sourceMappingURL=lenis_snap.js.map
