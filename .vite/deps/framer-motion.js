...
function calcGeneratorDuration(generator, timeStep = 50, maxDuration = maxGeneratorDuration, keyframes2) {
  ...
  keyframes2 == null ? void 0 : keyframes2.push(state.value);
...
function createEffect(addValue, { step, ...options } = {}) {
  ...
  return Object.assign(effect, options, {
    get: (subject, key) => {
      var _a;
      return (_a = stateCache.get(subject)) == null ? void 0 : _a.get(key);
    }
  });
}
...
function shouldForward(key, isValidProp) {
  return key.startsWith("on") ? !isValidMotionProp(key) : (isValidProp == null ? void 0 : isValidProp(key)) ?? !isValidMotionProp(key);
}
...
function ReorderGroupComponent({ children, as = "ul", axis: axisOverride, onReorder, values, ...props }, externalRef) {
  ...
  const context = {
    ...
    updateOrder: (item, offset, velocity) => {
      ...
      const direction = ((_b = (_a = groupRef.current) == null ? void 0 : _a.ownerDocument.defaultView) == null ? void 0 : _b.getComputedStyle(groupRef.current).direction) === "rtl" ? "rtl" : "ltr";
